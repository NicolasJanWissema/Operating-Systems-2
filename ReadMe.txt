...
-make docs: makes code documentation in docs directory.
-make clean: removes class files in bin directory.
-make cleandocs: removes documentation in docs directory.